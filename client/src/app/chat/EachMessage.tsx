...
export default function EachMessage({
  ...
  const isUrl = messageText.match(urlRegex);
  if (isUrl) {
    return (
      <div className="flex items-center py-4 border-b-[1px] border-[#D8D8D8]">
        ...
        <Link
          href={messageText}
          className={`w-full text-sm sm:text-base  text-blue-600`}
        >
          {messageText}
        </Link>
        <div className=" flex items-center gap-3">
          ...
          >
            <path
              fill-rule="evenodd"
              clip-rule="evenodd"
              d="M3.87503 0.125H13.25C13.4158 0.125 13.5748 0.190848 13.692 0.308058C13.8092 0.425268 13.875 0.58424 13.875 0.75V10.125C13.875 10.2908 13.8092 10.4497 13.692 10.5669C13.5748 10.6842 13.4158 10.75 13.25 10.75C13.0843 10.75 12.9253 10.6842 12.8081 10.5669C12.6909 10.4497 12.625 10.2908 12.625 10.125V2.25833L1.1917 13.6917C1.07322 13.8021 0.916517 13.8622 0.754599 13.8593C0.592682 13.8565 0.438194 13.7909 0.323683 13.6764C0.209173 13.5618 0.143579 13.4074 0.140722 13.2454C0.137866 13.0835 0.197968 12.9268 0.308368 12.8083L11.7417 1.375H3.87503C3.70927 1.375 3.5503 1.30915 3.43309 1.19194C3.31588 1.07473 3.25003 0.91576 3.25003 0.75C3.25003 0.58424 3.31588 0.425268 3.43309 0.308058C3.5503 0.190848 3.70927 0.125 3.87503 0.125Z"
              fill="black"
            />
          </svg>
          <svg
  ...
  return (
    <div className="flex items-center py-4 border-b-[1px] border-[#D8D8D8]">
      ...
      <p className={`w-full text-sm sm:text-base  ${isUrl && "text-blue-600"}`}>
        {messageText}
      </p>
      <div className=" flex items-center gap-3">
        <svg
